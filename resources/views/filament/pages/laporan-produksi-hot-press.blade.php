                        ...
                        <table class="w-full text-[11px] border-collapse border border-zinc-300 dark:border-zinc-700">
                            <thead>
                                <tr class="bg-zinc-100 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 uppercase font-bold">
                                    <th class="p-2 border border-zinc-300 dark:border-zinc-700">Kategori</th>
                                    <th class="p-2 border border-zinc-300 dark:border-zinc-700 text-left">Bahan / Biaya</th>
                            ...
                            <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                                ...
                                <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                                    ...
                                    <td class="p-2 border border-zinc-300 dark:border-zinc-700 text-center">{{ number_format($m['banyak'], 2, ',', '.') }}</td>
                                    <td class="p-2 border border-zinc-300 dark:border-zinc-700 text-right">Rp {{ number_format($m['harga'], 0, ',', '.') }}</td>
                                    <td class="p-2 border border-zinc-300 dark:border-zinc-700 text-right font-bold bg-yellow-50/50 dark:bg-yellow-900/10">Rp {{ number_format($m['total'], 0, ',', '.') }}</td>
                                </tr>
                                @endforeach
                                
                                {{-- BIAYA LAIN-LAIN --}}
                                <tr class="bg-zinc-50 dark:bg-zinc-800/30 font-semibold italic">
                                    <td class="p-2 border border-zinc-300 dark:border-zinc-700 text-center text-zinc-400">Biaya</td>
                                    ...
                                    <td class="p-2 border border-zinc-300 dark:border-zinc-700 text-right">Rp {{ number_format($data['penyusutan'], 0, ',', '.') }}</td>
                                </tr>
                                <tr class="bg-zinc-50 dark:bg-zinc-800/30 font-semibold italic">
                                    <td class="p-2 border border-zinc-300 dark:border-zinc-700 text-center text-zinc-400">Biaya</td>
                                ...
                                <tr class="bg-zinc-50 dark:bg-zinc-800/30 font-semibold italic">
                                    ...
                                    <td class="p-2 border border-zinc-300 dark:border-zinc-700 text-right">Rp {{ number_format($data['total_pekerja'] * $data['harga_pekerja'], 0, ',', '.') }}</td>
                                </tr>
                            </tbody>
                            <tfoot>
                                @php
                                ...
                                <tr class="bg-zinc-800 text-white font-bold text-xs">
                                    <td colspan="4" class="p-3 text-right uppercase tracking-widest">Grand Total Biaya:</td>
                        ...
                        <table class="w-full text-[11px] border-collapse border border-zinc-300 dark:border-zinc-700">
                            <thead>
                                <tr class="bg-zinc-100 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 uppercase font-bold">
                                    ...
                                    <th class="p-2 border border-zinc-300 dark:border-zinc-700 text-center">Banyak</th>
                                    <th class="p-2 border border-zinc-300 dark:border-zinc-700 text-left">Nama Barang</th>
                            ...
                            <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                                ...
                                <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                                    ...
                                    <td class="p-2 border border-zinc-300 dark:border-zinc-700">{{ $h['nama_barang'] }}</td>
                            ...
                            <tfoot>
                                ...
                                <tr class="bg-zinc-100 dark:bg-zinc-800 font-bold">
                                    <td colspan="3" class="p-2 text-right border border-zinc-300 dark:border-zinc-700">TOTAL:</td>
