...
class KediWorkerMap
{
    public static function make($collection): array
    {
        ...
        foreach ($collection as $produksi) {
            ...
            $tanggalAktual = $produksi->tanggal ? Carbon::parse($produksi->tanggal)->toDateString() : now()->toDateString();
            ...
            if ($produksi->detailPegawaiKedi) {
                foreach ($produksi->detailPegawaiKedi as $dp) {
                    ...
                    $jamMasuk = $dp->masuk ? Carbon::parse($tanggalAktual . ' ' . Carbon::parse($dp->masuk)->format('H:i:s'))->format('Y-m-d H:i:s') : null;
                    $jamPulang = $dp->pulang ? Carbon::parse($tanggalAktual . ' ' . Carbon::parse($dp->pulang)->format('H:i:s'))->format('Y-m-d H:i:s') : null;
