                            ...
                            <div class="space-y-4" x-data="{ openMasuk: true, openKeluar: true }">
                                <div class="rounded-lg border border-gray-200 dark:border-white/10 overflow-hidden">
                                    <button @click="openMasuk = !openMasuk"
                                        ...
                                        <svg class="w-4 h-4 transition-transform" :class="openMasuk ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="rounded-lg border border-gray-200 dark:border-white/10 overflow-hidden">
                                    <button @click="openKeluar = !openKeluar"
                                        ...
                                        <svg class="w-4 h-4 transition-transform" :class="openKeluar ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                        </svg>
                                    </button>
