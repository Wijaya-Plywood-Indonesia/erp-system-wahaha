<x-filament-panels::page>
    {{-- Helper macro: field wrapper dengan label proper --}}
    @php
    ...
    <div class="space-y-6">
        ...
        {{-- ═══════════════════════════════════════════
             HEADER DOKUMEN
        ═══════════════════════════════════════════ --}}
        <x-filament::section heading="Informasi Dokumen BK">
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div class="{{ $fieldClass }}">
                    <label class="{{ $labelClass }}">No. Nota BK <span class="text-danger-500">*</span></label>
                    <x-filament::input.wrapper>
                        <x-filament::input type="text" wire:model.live="no_nota" placeholder="BK-001..." />
                    </x-filament::input.wrapper>
                    @error('no_nota') <p class="text-xs text-danger-500">{{ $message }}</p> @enderror
                </div>

                <div class="{{ $fieldClass }}">
                    <label class="{{ $labelClass }}">Tujuan / Penerima <span class="text-danger-500">*</span></label>
                    <x-filament::input.wrapper>
                        <x-filament::input type="text" wire:model.live="tujuan_nota" placeholder="Nama tujuan..." />
                    </x-filament::input.wrapper>
        ...
        <x-filament::section heading="Tambah Barang">
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                ...
                {{-- Stok Saat Ini (read-only, same height as other inputs) --}}
                <div class="{{ $fieldClass }}">
                    <label class="{{ $labelClass }}">Stok Saat Ini (Sistem)</label>
                    <x-filament::input.wrapper
                        :class="$stok_sistem > 0 ? 'border-success-400 dark:border-success-500' : 'border-gray-300 dark:border-gray-600'"
                    >
                        <div class="flex w-full items-center justify-between px-3 py-2 text-sm font-semibold
                            {{ $stok_sistem > 0 ? 'text-success-600 dark:text-success-400' : 'text-gray-400 dark:text-gray-500' }}">
                ...
                {{-- Qty Keluar --}}
                <div class="{{ $fieldClass }}">
                    <label class="{{ $labelClass }}">Jumlah Keluar (Lembar) <span class="text-danger-500">*</span></label>
                    <x-filament::input.wrapper>
                        <x-filament::input
                            type="number"
        ...
        <x-filament::section>
            <div class="flex flex-col items-center justify-center py-10 text-gray-400 dark:text-gray-600">
                <x-heroicon-o-shopping-cart class="w-12 h-12 mb-3 opacity-30" />
