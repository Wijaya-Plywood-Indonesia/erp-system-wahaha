...
namespace App\Filament\Resources\ProduksiGuellotines\Tables;
...
class ProduksiGuellotinesTable
{
                    ...
                    ->before(function ($record) {
                        ...
                        if ($hasRelation) {
                            Notification::make()
                                ...
                                ->body('Produksi Guellotine ini masih memiliki data terkait di dalamnya.')
                                ->danger()
                                ->send();
