    ...
    protected function getHeaderActions(): array
    {
        return [
            Action::make('validasi')
                ...
                ->modalHeading('Validasi Nota BM')
                ->modalDescription('Stok veneer akan langsung ditambahkan setelah Anda memvalidasi nota ini. Tindakan ini tidak dapat dibatalkan.')
                ...
                ->action(function () {
                    try {
                        ...
                        $hasMutasi = \App\Models\VeneerMutasi::where('id_nota_bm', $this->record->id)->exists();
