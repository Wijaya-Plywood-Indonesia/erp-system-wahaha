...
namespace App\Filament\Resources\ProduksiPotAfJoints\Tables;
...
class ProduksiPotAfJointsTable
{
            ...
            ->recordActions([
                ...
                DeleteAction::make()
                    ...
                    ->before(function ($record) {
                        ...
                        $hasRelation =
                            $record->pegawaiPotAfJoint()->exists()
                            || $record->hasilPotAfJoint()->exists()
                            || $record->validasiPotAfJoint()->exists();

                        if ($hasRelation) {
                            Notification::make()
                                ->title('Data tidak dapat dihapus')
                                ->body('Produksi Pot AF Joint ini masih memiliki data terkait.')
                                ->danger()
                                ->send();
                            ...
                            foreach ($records as $record) {
                                ...
                                if ($hasRelation) {
                                    Notification::make()
                                        ...
                                        ->body('Salah satu Produksi Pot AF Joint masih memiliki relasi.')
                                        ->danger()
                                        ->send();
