...
namespace App\Filament\Resources\PegawaiPilihVeneers\Schemas;
            ...
            Select::make('id_pegawai')
                ...
                ->rule(function ($livewire) {
                    return function (string $attribute, $value, $fail) use ($livewire) {
                        ...
                        $query = PegawaiPilihVeneer::query()
                            ->where('id_produksi_pilih_veneer', $produksiId)
                        ...
                        if ($query->exists()) {
                            $fail('Pegawai ini sudah terdaftar pada produksi pilih veneer ini.');
                        }
                    };
                }),
            ]);
