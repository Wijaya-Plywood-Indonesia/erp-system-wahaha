...
namespace App\Filament\Resources\VeneerKeluars\Tables;
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('no_nota')
                    ...
                    ->searchable()
                    ->sortable()
                    ->url(fn ($record) => $record->id_nota_bk
                        ? route('filament.admin.resources.nota-barang-keluars.view', ['record' => $record->id_nota_bk])
                        : null
                    )
                    ->color('primary'),
                ...
                TextColumn::make('status')
                    ...
                    ->color(fn ($record): string =>
                        $record->notaBk?->divalidasi_oleh !== null
                            ? 'success'
                            : 'warning'
                    )
