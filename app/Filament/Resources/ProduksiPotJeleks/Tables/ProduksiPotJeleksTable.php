...
namespace App\Filament\Resources\ProduksiPotJeleks\Tables;
            ...
            ->recordActions([
                ...
                DeleteAction::make()
                    ...
                    ->before(function ($record) {
                        ...
                        $hasDetail =
                            $record->pegawaiPotJelek()->exists()
                            || $record->detailBarangDikerjakanPotJelek()->exists()
                            || $record->validasiPotJelek()->exists();

                        if ($hasDetail) {
                            Notification::make()
                                ->title('Data tidak dapat dihapus')
                                ->body('Produksi Pot Jelek ini masih memiliki data didalamnya yang terkait.')
                                ->danger()
                                ->send();

                            // ⛔ Hentikan delete (PENTING)
                            throw new Halt();
                        }
                    }),
            ])
